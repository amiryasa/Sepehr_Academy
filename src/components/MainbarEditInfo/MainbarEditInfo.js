  ...
  return (
    ...
    <div className="MainbarEditInfo">
      ...
      <div className="MainbarEditInfoInputs">
        <div> <Input title="نام کاربری" className="enterInputPanel" /> </div>
        <div> <Input title="شماره تماس" className="enterInputPanel" /> </div>
        <div> <Input title="شماره ملی" className="enterInputPanel" /> </div>
        <div> <Input title="تاریخ تولد" className="enterInputPanel" /> </div>
        <div> <Input title="ایمیل" className="enterInputPanel" /> </div> 
      </div>
